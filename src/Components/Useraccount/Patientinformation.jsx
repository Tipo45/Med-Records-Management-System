      ...
      >
        ...
        <div className="col-span-1">
          <div className="flex gap-2 items-center mb-4">
            <h1 className="text-2xl font-bold text-gray-800 capitalize font-secondary">
              {patient.fullname}
            </h1>
            <span className="text-lg text-gray-500 font-primary font-semibold">
        ...
        <div className="space-y-2">
          <h2 className="font-semibold text-gray-700 font-secondary">
            Contact
          </h2>
          <div className="text-gray-600 font-primary">(+234) {patient.phone}</div>
          <div className="text-gray-600 font-primary text-sm truncate">
            {patient.email}
          </div>
